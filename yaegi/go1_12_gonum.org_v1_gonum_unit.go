...
func init() {
	Symbols["gonum.org/v1/gonum/unit"] = map[string]reflect.Value{
		...
		"Kilo":                 reflect.ValueOf(unit.Kilo),
		...
		"Mega":                 reflect.ValueOf(unit.Mega),
		...
		"One":                  reflect.ValueOf(unit.One),
		"Pascal":               reflect.ValueOf(unit.Pascal),
		"Peta":                 reflect.ValueOf(unit.Peta),
		...
		"Tera":                 reflect.ValueOf(unit.Tera),
		...
		"Yotta":                reflect.ValueOf(unit.Yotta),
		"Zepto":                reflect.ValueOf(unit.Zepto),
		"Zetta":                reflect.ValueOf(unit.Zetta),
