...
func init() {
	Symbols["gonum.org/v1/gonum/lapack/testlapack"] = map[string]reflect.Value{
		...
		"Dlasq3Test":       reflect.ValueOf(testlapack.Dlasq3Test),
		"Dlasq4Test":       reflect.ValueOf(testlapack.Dlasq4Test),
		"Dlasq5Test":       reflect.ValueOf(testlapack.Dlasq5Test),
		...
		"Dlahr2test":    reflect.ValueOf((*testlapack.Dlahr2test)(nil)),
		...
		"Dlaqr5test":    reflect.ValueOf((*testlapack.Dlaqr5test)(nil)),
		...
		"Dlasq3er":      reflect.ValueOf((*testlapack.Dlasq3er)(nil)),
		"Dlasq4er":      reflect.ValueOf((*testlapack.Dlasq4er)(nil)),
		"Dlasq5er":      reflect.ValueOf((*testlapack.Dlasq5er)(nil)),
		...
		"_Dlasq3er":   reflect.ValueOf((*_gonum_org_v1_gonum_lapack_testlapack_Dlasq3er)(nil)),
		"_Dlasq4er":   reflect.ValueOf((*_gonum_org_v1_gonum_lapack_testlapack_Dlasq4er)(nil)),
		"_Dlasq5er":   reflect.ValueOf((*_gonum_org_v1_gonum_lapack_testlapack_Dlasq5er)(nil)),
...
func (W _gonum_org_v1_gonum_lapack_testlapack_Dlasq1er) Dgetrf(m int, n int, a []float64, lda int, ipiv []int) bool {
	return W.WDgetrf(m, n, a, lda, ipiv)
}
...
func (W _gonum_org_v1_gonum_lapack_testlapack_Dlasq2er) Dgetrf(m int, n int, a []float64, lda int, ipiv []int) bool {
	return W.WDgetrf(m, n, a, lda, ipiv)
}
...
// _gonum_org_v1_gonum_lapack_testlapack_Dlasq3er is an interface wrapper for Dlasq3er type
type _gonum_org_v1_gonum_lapack_testlapack_Dlasq3er struct {
	WDlasq3 func(i0 int, n0 int, z []float64, pp int, dmin float64, sigma float64, desig float64, qmax float64, nFail int, iter int, nDiv int, ttype int, dmin1 float64, dmin2 float64, dn float64, dn1 float64, dn2 float64, g float64, tau float64) (i0Out int, n0Out int, ppOut int, dminOut float64, sigmaOut float64, desigOut float64, qmaxOut float64, nFailOut int, iterOut int, nDivOut int, ttypeOut int, dmin1Out float64, dmin2Out float64, dnOut float64, dn1Out float64, dn2Out float64, gOut float64, tauOut float64)
}

func (W _gonum_org_v1_gonum_lapack_testlapack_Dlasq3er) Dlasq3(i0 int, n0 int, z []float64, pp int, dmin float64, sigma float64, desig float64, qmax float64, nFail int, iter int, nDiv int, ttype int, dmin1 float64, dmin2 float64, dn float64, dn1 float64, dn2 float64, g float64, tau float64) (i0Out int, n0Out int, ppOut int, dminOut float64, sigmaOut float64, desigOut float64, qmaxOut float64, nFailOut int, iterOut int, nDivOut int, ttypeOut int, dmin1Out float64, dmin2Out float64, dnOut float64, dn1Out float64, dn2Out float64, gOut float64, tauOut float64) {
	return W.WDlasq3(i0, n0, z, pp, dmin, sigma, desig, qmax, nFail, iter, nDiv, ttype, dmin1, dmin2, dn, dn1, dn2, g, tau)
}

// _gonum_org_v1_gonum_lapack_testlapack_Dlasq4er is an interface wrapper for Dlasq4er type
type _gonum_org_v1_gonum_lapack_testlapack_Dlasq4er struct {
	WDlasq4 func(i0 int, n0 int, z []float64, pp int, n0in int, dmin float64, dmin1 float64, dmin2 float64, dn float64, dn1 float64, dn2 float64, tau float64, ttype int, g float64) (tauOut float64, ttypeOut int, gOut float64)
}

func (W _gonum_org_v1_gonum_lapack_testlapack_Dlasq4er) Dlasq4(i0 int, n0 int, z []float64, pp int, n0in int, dmin float64, dmin1 float64, dmin2 float64, dn float64, dn1 float64, dn2 float64, tau float64, ttype int, g float64) (tauOut float64, ttypeOut int, gOut float64) {
	return W.WDlasq4(i0, n0, z, pp, n0in, dmin, dmin1, dmin2, dn, dn1, dn2, tau, ttype, g)
}

// _gonum_org_v1_gonum_lapack_testlapack_Dlasq5er is an interface wrapper for Dlasq5er type
type _gonum_org_v1_gonum_lapack_testlapack_Dlasq5er struct {
	WDlasq5 func(i0 int, n0 int, z []float64, pp int, tau float64, sigma float64) (i0Out int, n0Out int, ppOut int, tauOut float64, sigmaOut float64, dmin float64, dmin1 float64, dmin2 float64, dn float64, dnm1 float64, dnm2 float64)
}

func (W _gonum_org_v1_gonum_lapack_testlapack_Dlasq5er) Dlasq5(i0 int, n0 int, z []float64, pp int, tau float64, sigma float64) (i0Out int, n0Out int, ppOut int, tauOut float64, sigmaOut float64, dmin float64, dmin1 float64, dmin2 float64, dn float64, dnm1 float64, dnm2 float64) {
	return W.WDlasq5(i0, n0, z, pp, tau, sigma)
}
...
func (W _gonum_org_v1_gonum_lapack_testlapack_Dsterfer) Dgetrf(m int, n int, a []float64, lda int, ipiv []int) bool {
	return W.WDgetrf(m, n, a, lda, ipiv)
}
