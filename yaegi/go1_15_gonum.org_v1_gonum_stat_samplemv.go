// Code generated by 'github.com/containous/yaegi/extract gonum.org/v1/gonum/stat/samplemv'. DO NOT EDIT.
...
func init() {
	Symbols["gonum.org/v1/gonum/stat/samplemv"] = map[string]reflect.Value{
		...
		"Owen":              reflect.ValueOf(constant.MakeFromLiteral("1", token.INT, 0)),
