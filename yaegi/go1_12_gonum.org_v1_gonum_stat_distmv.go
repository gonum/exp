// Code generated by 'goexports gonum.org/v1/gonum/stat/distmv'. DO NOT EDIT.
...
func (W _gonum_org_v1_gonum_stat_distmv_LogProber) LogProb(x []float64) float64 {
	return W.WLogProb(x)
}
...
func (W _gonum_org_v1_gonum_stat_distmv_RandLogProber) Rand(x []float64) []float64 {
	return W.WRand(x)
}
