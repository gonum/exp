// Code generated by 'github.com/containous/yaegi/extract gonum.org/v1/gonum/mat'. DO NOT EDIT.
...
func init() {
	Symbols["gonum.org/v1/gonum/mat"] = map[string]reflect.Value{
		...
		"ConditionTolerance":     reflect.ValueOf(constant.MakeFromLiteral("10000000000000000", token.FLOAT, 0)),
		...
		"FormatMATLAB":           reflect.ValueOf(mat.FormatMATLAB),
		"FormatPython":           reflect.ValueOf(mat.FormatPython),
		...
		"MutableVector":        reflect.ValueOf((*mat.MutableVector)(nil)),
		...
		"_MutableVector":        reflect.ValueOf((*_gonum_org_v1_gonum_mat_MutableVector)(nil)),
...
// _gonum_org_v1_gonum_mat_MutableVector is an interface wrapper for MutableVector type
type _gonum_org_v1_gonum_mat_MutableVector struct {
	WAt     func(i int, j int) float64
	WAtVec  func(a0 int) float64
	WDims   func() (r int, c int)
	WLen    func() int
	WSetVec func(i int, v float64)
	WT      func() mat.Matrix
}

func (W _gonum_org_v1_gonum_mat_MutableVector) At(i int, j int) float64 { return W.WAt(i, j) }
func (W _gonum_org_v1_gonum_mat_MutableVector) AtVec(a0 int) float64    { return W.WAtVec(a0) }
func (W _gonum_org_v1_gonum_mat_MutableVector) Dims() (r int, c int)    { return W.WDims() }
func (W _gonum_org_v1_gonum_mat_MutableVector) Len() int                { return W.WLen() }
func (W _gonum_org_v1_gonum_mat_MutableVector) SetVec(i int, v float64) { W.WSetVec(i, v) }
func (W _gonum_org_v1_gonum_mat_MutableVector) T() mat.Matrix           { return W.WT() }
