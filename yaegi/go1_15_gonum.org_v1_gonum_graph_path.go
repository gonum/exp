// Code generated by 'github.com/containous/yaegi/extract gonum.org/v1/gonum/graph/path'. DO NOT EDIT.
...
func init() {
	Symbols["gonum.org/v1/gonum/graph/path"] = map[string]reflect.Value{
		...
		"BellmanFordAllFrom": reflect.ValueOf(path.BellmanFordAllFrom),
		"BellmanFordFrom":    reflect.ValueOf(path.BellmanFordFrom),
		"DijkstraAllFrom":    reflect.ValueOf(path.DijkstraAllFrom),
		...
		"ShortestAlts":           reflect.ValueOf((*path.ShortestAlts)(nil)),
